...
def build_prompt(
    ...
    Keeps wording tight for JSON-only behavior and high-quality output. 5a37524 (Initial commit of Content365 project)
    """
...
{{
  ...
  "hashtags": {{
    "Instagram": ["tag1","tag2"], 5a37524 (Initial commit of Content365 project)
    "LinkedIn": ["tag1","tag2"],
    "TikTok": ["tag1","tag2"],
    "Twitter": ["tag1","tag2"],
    "Facebook": ["tag1","tag2"]
